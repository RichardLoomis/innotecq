...
export default function ChatPane({ agent, thread, mode, modes, endpoints, onMode, onSend, onReset }) {
  ...
  return (
    <main className="chat">
      <Topbar agent={agent} mode={mode} modes={modes} onMode={onMode} onReset={onReset} />
